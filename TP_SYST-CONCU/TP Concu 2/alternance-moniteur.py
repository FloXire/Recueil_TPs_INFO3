...
class Moniteur_PingPong():
    def __init__(self):
        ...
        self.fifoPing = threading.Condition(self.mutex)
        self.fifoPong = threading.Condition(self.mutex)
...
def moniteur_ping_pong(moniteur, nom, i):
    ...
    if nom == "ping" :
        moniteur.tour = "pong"
        moniteur.fifoPong.notify()
    else:
        moniteur.tour = "ping"
        moniteur.fifoPing.notify()
