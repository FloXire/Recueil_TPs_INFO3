...
def thread_T1() :
    ...
    tprint( 'T1 : Demande P(libre})')
    libre.acquire()
    tprint( 'T1 : Obtient P(libre})')
    ...
    # restitution d'un jeton dans le semaphore libre
    tprint( 'T1 : v(libre)' )
    libre.release()
...
def thread_T2() :
    ...
    # prise d'un jeton dans le semaphore libre
    tprint( 'T2 : Demande P(libre})')
    libre.acquire()
    tprint( 'T2 : Obtient P(libre})')
