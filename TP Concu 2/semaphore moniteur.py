...
#
# Implementation d'un sémaphore de comptage à partir des moniteurs python (Lock et Condition)
#
...
class Semaphore_moniteur():
    def __init__(self,counter=0):
        ...
        self.fifo = threading.Condition(self.mutex)
...
# Test 1 : Exemple de trace d'execution (chronogramme)
...
# Avec :
# Processus={P1,P2}
# PE: nom du point d'entree (P ou V)
# MP: Processus en cours dans le moniteur (theorique)
# MPE: nom du point d'entr?e en cours dans le moniteur (theorique) (P ou V)
# MF: Liste d'attente en entree du moniteur (theorique)
# Mu: valeur du Mutex d'acc?s au moniteur(acces reel)
# MuF: liste d'attente du Mutex d'acc?s au moniteur(acces reel)
